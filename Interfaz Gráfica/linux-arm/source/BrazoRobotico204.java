...
public class BrazoRobotico204 extends PApplet {
...
public void setup() {
  ...
  scaleFactor = min(width, height) / 1000.0f; // Establece el factor de escala basado en las dimensiones de la pantalla
  ...
  /* size commented out by preprocessor */; // Establece el modo pantalla completa
  ...
  if (portList.length > 0) {
      ...
      cp5.addDropdownList("portDropdown")
         .setPosition((int)(width * 0.03f), (int)(height * 0.02f))
         .setSize((int)(width * 0.11f), (int)(height * 0.1f))
         .setBarHeight((int)(height * 0.02f))
         .setItemHeight((int)(height * 0.02f))
  ...
  int totalSliderHeight = (int)(6 * height * 0.04f); // 6 barras deslizadoras, cada una con 10% de la altura de la pantalla
  int totalSpacing = (int)(5 * height * 0.05f); // Espacio entre cada barra deslizadora, 5 en total
  ...
  int sliderWidth = (int)(width * 0.35f); // Ancho de la barra deslizadora
  ...
  for (int i = 0; i < 6; i++) {
    Slider slider = cp5.addSlider("servo_" + (i + 1))
      .setPosition(sliderX, startY + i * ((int)(height * 0.1f) + (int)(height * 0.01f)))
      .setSize(sliderWidth, (int)(height * 0.05f))
  ...
  cp5.addButton("cerrar")
     .setPosition((int)(width * 0.945f), (int)(height * 0.01f))
     .setSize((int)(width * 0.05f), (int)(height * 0.05f))
  ...
  cp5.addButton("guardarMovimientos")
     .setPosition((int)(width * 0.03f), (int)(height * 0.3f))
     .setSize((int)(width * 0.18f), (int)(height * 0.10f))
  ...
  cp5.addButton("reproducirMovimientos")
     .setPosition((int)(width * 0.03f), (int)(height * 0.45f))
     .setSize((int)(width * 0.18f), (int)(height * 0.10f))
  ...
  cp5.addButton("detenerMovimiento")
     .setPosition((int)(width * 0.03f), (int)(height * 0.6f))
     .setSize((int)(width * 0.18f), (int)(height * 0.10f))
  ...
  cp5.addSlider("velocidadReproduccion")
     .setPosition((int)(width * 0.03f), (int)(height * 0.75f))
     .setSize((int)(width * 0.18f), (int)(height * 0.05f))
     .setRange(200, 2000)
  ...
  cp5.addButton("exportarPosiciones")
     .setPosition((int)(width * 0.8f), (int)(height * 0.3f))
     .setSize((int)(width * 0.18f), (int)(height * 0.10f))
  ...
  cp5.addButton("importarPosiciones")
     .setPosition((int)(width * 0.8f), (int)(height * 0.45f))
     .setSize((int)(width * 0.18f), (int)(height * 0.10f))
...
// Botón para restablecer posiciones guardadas
  cp5.addButton("resetearPosiciones")
     .setPosition((int)(width * 0.8f), (int)(height * 0.6f))
     .setSize((int)(width * 0.18f), (int)(height * 0.10f))
...
public void actualizarPuertos() {
  ...
  if (portList.length > 0) {
    // Si hay puertos disponibles, configurar el menú desplegable para seleccionar el puerto COM
    cp5.addDropdownList("portDropdown")
       .setPosition((int)(width * 0.03f), (int)(height * 0.09f))
       .setSize((int)(width * 0.18f), (int)(height * 0.15f)) // Aumentar tamaño de los cuadros
       .setBarHeight((int)(height * 0.05f)) // Ajustar altura de la barra del menú desplegable
       .setItemHeight((int)(height * 0.05f)) // Ajustar altura de los elementos del menú desplegable para centrar el texto verticalmente
       .setCaptionLabel("Selecciona el puerto")
       .setItems(portList)
...
public boolean sonIguales(String[] arr1, String[] arr2) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#000000", "--stop-color=#000000", "BrazoRobotico204" };
    if (passedArgs != null) {
