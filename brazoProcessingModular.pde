...
String fabriMessage = "F        A        B        R        I                    C        R        E        A        T        O        R";
...
void setup() {
  ...
  P = loadImage("Logo con título.png");
